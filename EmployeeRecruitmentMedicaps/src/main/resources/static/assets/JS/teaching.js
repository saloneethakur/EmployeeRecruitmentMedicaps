document.addEventListener('DOMContentLoaded', () => {
  ...
  const academicVaccancy = document.getElementById('academic-btn')
  const viewAcademicVaccancy = document.getElementById('container-display')

  academicVaccancy.addEventListener('click', function (event) {
    event.preventDefault() // Prevent default link behavior
    viewAcademicVaccancy.style.display = // Display the form
      viewAcademicVaccancy.style.display === 'none' ? 'block' : 'none'
  })
