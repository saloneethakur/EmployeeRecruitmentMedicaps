...
<html lang="en">
    ...
    <nav>
      ...
      <div class="navigation">
        <ul>
          ...
          <li><a href="/medicaps/vacancies">View Vacancy</a></li>
          <li><a href="#academics">Applied Applications</a></li>       
          <li><a onclick="location.href='/user/profile'"> Profile </a></li>
        </ul>
      </div>
      <div class="hamburger">
        <span></span>
  ...
  <div class="background-content">
    ...
    <p>Your future starts here</p>
     <button class="view-vacancy-btn" onclick="location.href='/medicaps/vacancies'" >View Vacancies</button>
...
<link rel="script" href="homeppage.js" />
</html>
